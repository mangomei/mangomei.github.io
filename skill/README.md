...
<div id="container" class="layui-container">
    <div style="position:fixed;right:10px;bottom:50px;">
        <img style="width:40px;border:1px solid green;" src="https://mg.meiflower.top/res/drawio/okr/2023/q2.drawio.png"/>
    </div>
            ...
            data() {
                return {
                    nodes: [
                        ...
                        {
                            moduleName: '计算机语言学习',
                            parts:['Java体系学习@2@https://java.meiflower.top/','Python体系学习']
                        },
                        {
                            moduleName: '编程基石',
                            parts:['数据结构与算法@2@https://alg.meiflower.top/','设计模式@1@https://dp.meiflower.top/']
                        },
                        {
                            moduleName: '计算机基础',
